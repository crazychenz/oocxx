...
void cash_out(BankRoll &bankroll)
{
    cout << endl << "--------------------" << endl;
    cout << " Cashed Out" << endl;
    cout << "--------------------" << endl;

    cout << "You now have " << bankroll.cash_out() << " coins to spend." << endl;
}

void add_coins(BankRoll &bankroll)
{
    cout << endl << "--------------------" << endl;
    cout << " Add Coins" << endl;
    cout << "--------------------" << endl;
...
void place_bet(BankRoll &bankroll)
{
    cout << endl << "--------------------" << endl;
    cout << " Place Bet" << endl;
    cout << "--------------------" << endl;
...
void main_menu(BankRoll &bankroll)
{
    int choice = 0;

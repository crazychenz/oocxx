...
# 2. Create (resolved) reference entries for all refs (as substitution entries) in the prolog
...
latex_documents = [
    (master_doc, 'proj1.tex', u'proj1 Documentation',
     u'author1', 'manual'),
]
...
man_pages = [
    (master_doc, 'proj1', u'proj1 Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'proj1', u'proj1 Documentation',
     author, 'proj1', 'One line description of project.',
     'Miscellaneous'),
]
